...
- GitHub account with access to the workshop repository:
  [gravity9-tech/devin-pandora](https://github.com/gravity9-tech/devin-pandora)
...
- Check that your GitHub account has access to `gravity9-tech/devin-pandora`

**Jira integration not working:**
- Ensure the dedicated Devin Jira account has been created and connected
